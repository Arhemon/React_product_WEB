...
function AstronautTitleThree({ cardTitle, cardDate, source }: IAstronautTitleThree) {
        ...
        <>
            ...
            <div className='container_astronautThree'>
                <div className='left_post_astranautThree'>
                    ...
                    <h3 className='astronautThree_title'>{cardTitle}</h3>
                </div>
                <img src={source} alt="" className='astronautThree_image' />
                <div className='low_astranautThree_post '>
                    <div className='low_astranautThree_post'>
...
export default AstronautTitleThree;
