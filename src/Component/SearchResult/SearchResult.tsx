...
import AstronautTitleThree from '../AstronautTitleTree/AstronautTitleTree';
import { dataSet } from '../../Component/AstronautTitle/data';
import AstronautTitleTwo from '../AstronautTitleTwo/AstronautTitleTwo';
import AstronautTitle from '../AstronautTitle/AstronautTitle';
import AstronautTitleFour from '../AstronautTitleFour/AstranautTitleFour';
    ...
    return (
        <>
            <div className='container_search'>
                <div className='text_search_result'>Search results ‘Astronauts’</div>
                <div className='container_blog_astranaut'>
                    <AstronautTitleFour cardDate={dataSet[1].date} cardTitle={dataSet[1].title} source={dataSet[1].image}></AstronautTitleFour>
                    <AstronautTitleFour cardDate={dataSet[1].date} cardTitle={dataSet[1].title} source={dataSet[1].image}></AstronautTitleFour>
                    <AstronautTitleFour cardDate={dataSet[1].date} cardTitle={dataSet[1].title} source={dataSet[1].image}></AstronautTitleFour>
                    <AstronautTitleFour cardDate={dataSet[1].date} cardTitle={dataSet[1].title} source={dataSet[1].image}></AstronautTitleFour>
                    <AstronautTitleFour cardDate={dataSet[1].date} cardTitle={dataSet[1].title} source={dataSet[1].image}></AstronautTitleFour>
