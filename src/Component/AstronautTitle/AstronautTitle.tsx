...
import { clickLike, clickDislike } from ".//../..//Slice/actionRedux";
...
function AstronautTitle({ cardTitle, cardDate, source, postText }: IAstronautTitle) {
    ...
    const likes = useSelector((state: any) => state.clickLike.likes);

    const handleLike = () => {
        dispatch(clickLike(likes + 1))
    };

    const handleDislike = () => {
        dispatch(clickDislike(likes + 1));
    };
                ...
                <div className='container_astronaut'>
                    ...
                    <div className='low_astranaut_post'>
                        <div className='low_astranaut_left'>
                            <button className='astronaut_like' onClick={handleLike} >
                            ...
                            <button className='astronaut_like' onClick={handleDislike}>
